...
export const generateStoryFromWords = async (
  ...
  try {
    ...
    const prompt = `
      ...
      STRICT OUTPUT RULES:
      1. Wrap every occurrence of the input words (and their conjugated forms) in <b> tags. Example: <b>word</b>.
      2. Provide a translation in ${nativeLang.name} immediately after the story.
      3. In the translation, ALSO wrap the translated meanings of the input words in <b> tags.
      4. Do not use Markdown bold (**). Use HTML <b> tags only.
